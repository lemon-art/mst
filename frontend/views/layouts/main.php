...
<div class="site_wrap">
   ...
   ?>
    <?if ( Yii::$app->request->url !== Yii::$app->homeUrl ):?>
		...
		<?php//if ( (strpos(Yii::$app->request->url, 'services')  === false) || (strpos(Yii::$app->request->url, 'credit')  === false) ):?>
		<?if ( Yii::$app->controller->id  != 'services' || Yii::$app->controller->id  != 'credit' ):?>
