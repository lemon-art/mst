...
$(document).ready(function(){
	...
	$( "#ipoteka-name" ).change(function( ) {
		if ( $('#ipoteka-name').parent().hasClass('has-success') && $('#ipoteka-phone').parent().hasClass('has-success') ){
			SaveLastOrder( );
		}
	});
	...
	function SaveLastOrder( ){
		...
		var service_id = $('.service_id').val();
		var secret_key = $('#ipoteka-secret_key').val();
		var name = $('#ipoteka-name').val();
		var phone = $('#ipoteka-phone').val();
