...
/* @var $model app\models\OffersIpotekaSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="offers-ipoteka-search">
    ...
    <?php // echo $form->field($model, 'min_summ_ipoteka') ?>

    <?php // echo $form->field($model, 'max_summ_ipoteka') ?>
